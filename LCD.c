...
void Lcd_DisplayCharacter (char a_char)
 ...
 void InitChar(void)	    // funkcja tworzy znaczek '\'
{
  // kwadracik zjadany przez pacmana, odwolanie do znaku - 0x00
  Lcd_WriteControl(0x40); 	// ustawienie zerowego adresu w rejestrze pamieci CGRAM. Jesli chce sie nowy jeszcze znak to (0x48)
  Lcd_WriteData(0x00);		// tutaj sie podaje 8 bitow i 5 z nich jest znaczacych. 3 starsze sa zawsze zerami.
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x0C);
  Lcd_WriteData(0x0C);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // pacman animacja 1 - kulka. odwolanie do znaku - 0x01
  Lcd_WriteControl(0x48); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x0E);
  Lcd_WriteData(0x1F);
  Lcd_WriteData(0x1F);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // pacman animacja 2 - otwarta paszcza. odwolanie do znaku - 0x02
  Lcd_WriteControl(0x50); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x0F);
  Lcd_WriteData(0x1E);
  Lcd_WriteData(0x1C);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // dalsze adresy -> 0x58, 0x60, 0x68, 0x70, 0x78
  // ufo animacja 1 - 3 nozki. odwolanie do znaku - 0x03
  Lcd_WriteControl(0x58); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x0E);
  Lcd_WriteData(0x1F);
  Lcd_WriteData(0x15);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // ufo animacja 2 - 2 nozki. odwolanie do znaku - 0x04
  Lcd_WriteControl(0x60); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x0E);
  Lcd_WriteData(0x1F);
  Lcd_WriteData(0x15);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // pacman znikanie 1 - gorne cwierc kulki. Odwolanie do znaku - 0x05
  Lcd_WriteControl(0x68); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x0A);
  Lcd_WriteData(0x1B);
  Lcd_WriteData(0x1F);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // pacman znikanie 2 - pol kulki. Odwolanie do znaku - 0x06
  Lcd_WriteControl(0x70); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x1F);
  ...
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  // pacman znikanie 3 - dolne cwierc kulki. Odwolanie do znaku - 0x07
  Lcd_WriteControl(0x78); 
  Lcd_WriteData(0x00);	
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x04);
